...
Date: Mon, 18 May 2026 12:00:51 GMT
Content-Type: text/html
Transfer-Encoding: chunked
Connection: keep-alive
X-Powered-By: PHP/5.5.9-1ubuntu4.29
Set-Cookie: I_am_admin=68934a3e9455fa72420237eb05902327; expires=Mon, 18-May-2026 13:00:46 GMT; Max-Age=3600
...
The upload form validates the declared MIME type from the multipart request
but does not safely verify the actual file content or block executable extensions.
By sending a PHP file with Content-Type: image/jpeg
the application accepts the upload and reveals the flag.
...
- Check file magic bytes/content
